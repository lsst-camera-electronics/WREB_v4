...
-------------------------------------------------------------------------------
  ...
  constant FPGA_VERSION_C : std_logic_vector(31 downto 0) := x"1139400A";  -- MAKE_VERSION

  constant BUILD_STAMP_C : string := "WREB_v4: Vivado v2018.3 (x86_64) Built Tue Jul  1 17:34:01 PDT 2025 by jgt";
...
-- 400A Version that fixes reset to not cause CCS to power down sensors or open bias switch.
-------------------------------------------------------------------------------
